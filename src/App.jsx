...
function calcScore(pred, match) {
  ...
  const runPts = (a, b) => { const d = Math.abs(a - b); return d === 0 ? 30 : d <= 5 ? 20 : d <= 15 ? 10 : d <= 25 ? 5 : 0; };
  let pts = runPts(r1p, r1a) + (w1p === w1a ? 10 : 0) + runPts(r2p, r2a) + (w2p === w2a ? 10 : 0);
        ...
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          {step >= 3 && (
            <div className="up" style={{ textAlign: "center", marginTop: 20, fontFamily: PF, fontSize: 6, color: C.dim, lineHeight: 2.2 }}>
              Tiebreaker: earliest submission wins · Scored out of 100 pts
            </div>
          )}
        </div>
      )}
